.\" Manpage for _printf.
.TH _printf 3 "22 November 2022" "1.0" "User commands for _printf"
.SH NAME
...

{
	...
	_printf("Hello World! contains %d characters\n", length);

	length = _printf("Hello Betty!");
...
.R printf(3)
.SH AUTHORS
Written by \fBHongo Koffi Anderson\fR and \fBAnuola Osinaike\fR.
